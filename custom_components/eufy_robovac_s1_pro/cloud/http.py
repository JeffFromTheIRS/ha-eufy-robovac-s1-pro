"""Eufy AIOT cloud HTTP auth + device discovery.

Vendored, with only the const import adapted, from jeppesens/eufy-clean
(custom_components/robovac_mqtt/api/http.py). Kept faithful on purpose — this
reverse-engineered auth flow is proven and hard to test in isolation.
"""
