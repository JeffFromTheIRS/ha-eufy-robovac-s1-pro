"""AWS IoT MQTT transport for the Eufy AIOT cloud.

Vendored verbatim from jeppesens/eufy-clean
(custom_components/robovac_mqtt/api/client.py). Depends only on paho.mqtt,
which ships with Home Assistant core.
"""
